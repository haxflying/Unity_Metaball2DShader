...
public class MetaballDrawer : MonoBehaviour
{
    ...
    Material metaballShaderMaterial;
    ...
    void Update()
    {
        ...
        this.metaballShaderMaterial.SetBuffer("_MetaballBuffer", this.metaballBuffer);
    }

    void OnRenderImage(RenderTexture src, RenderTexture dest)
    {
        Graphics.Blit(src, dest, this.metaballShaderMaterial);
    }

    void OnDestroy()
    {
        GameObject.Destroy(this.metaballShaderMaterial);
        this.metaballBuffer.Dispose();
    }

    void Initialize()
    {
        this.metaballShaderMaterial = new Material(this.metaballShader);
